...
class InstructionStepItemsAdapter constructor(var context: Context, var list: List<Equipment?>?) :
    ...
    public override fun onBindViewHolder(
        ...
        Picasso.get().load(
            "https://spoonacular.com/cdn/equipment_100x100/" + list!!.get(position)?.image
...
internal class InstructionStepItemViewHolder constructor(itemView: View) :
