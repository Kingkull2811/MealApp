...
class InstructionsAdapter constructor(var context: Context, var list: List<InstructionsResponse>) :
    ...
    public override fun onBindViewHolder(holder: InstructionViewHolder, position: Int) {
        ...
        val instructionStepsAdapter: InstructionStepsAdapter =
            InstructionStepsAdapter(context, list.get(position).steps)
...
class InstructionViewHolder constructor(itemView: View) : RecyclerView.ViewHolder(itemView) {
    var textView_instruction_name: TextView
    var recycler_instruction_steps: RecyclerView
